...
##所有的細胞第二次重新分羣
seurat <- readRDS(file="cluster02_id_test.rds")
DimPlot(seurat, label = T) + NoLegend()
DimPlot(seurat, label = T) 
table(Idents(seurat))
##创建CDS对象并预处理数据
...
colData(cds)$assigned_cell_type <- as.character(partitions(cds))
colData(cds)$assigned_cell_type <- dplyr::recode(colData(cds)$seurat_clusters,
                                                 "0"= "T","1"= "Epithelial","2"="T","3"= "T","4"="T", 
                                                 "5"= "T","6"="T","7"= "T","8"="B","9"="T",
                                                 "10"= "T",  "11"="T", "12"="T",  "13"="T","14"="T",
                                                 "15"="T","16"="T", "17"="Epithelial",
                                                 "18"="Epithelial","19"="Macrophage","20"="T","21"= "nk",
                                                 "22"="B","23"="Epithelial",
                                                 "24"="T", "25"="dc", "26"="microglial",  "27"="endothelial",
                                                 "28"= "nk", "29"="B", "30"="B", "31"="Progenitor" )
